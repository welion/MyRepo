...
EOL1 = b'\n\n'
EOL2 = b'\n\r\n'
SERVER_RESPONSE = b"""HTTP/1.1 200 OK\r\nData: Mon, 27, Apr 2015 23:00:00 GMT\r\nContent-Type: text/plain\r\nContent-Length: 25\r\n\r\n
                ...
                for fileno, event in events:
                    if fileno == self.sock.fileno():
                        ...
                        if EOL1 in requests[fileno] or EOL2 in requests[fileno]:
                            ...
                            print('-'*40 + '\n' + requests[fileno].decode()[:-1])
                    elif event & select.EPOLLOUT:
                        bytewrites = connections[fileno].send(responses[fileno])
                        responses[fileno] = responses[fileno][bytewrites:]
