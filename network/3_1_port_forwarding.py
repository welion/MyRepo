...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="Starkless Socket Server Example")
	...
	local_host, local_port = given_args.local_host, given_args.local_port
	remote_host, remote_port = given_args.remote_host, given_args.remote_port
